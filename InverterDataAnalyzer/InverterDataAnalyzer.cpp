        ...
        case 4:
            {
                ...
                std::cout << "Podaj datę początkową dla okresu 1 (rok miesiąc dzień kwartał): ";
                std::cin >> startYear1 >> startMonth1 >> startDay1 >> startQuarter1;
                std::cout << "Podaj datę końcową dla okresu 1 (rok miesiąc dzień kwartał): ";
                std::cin >> endYear1 >> endMonth1 >> endDay1 >> endQuarter1;
        ...
        case 6:
            {
                ...
                std::cout << "Podaj datę końcową dla okresu 1 (rok miesiąc dzień kwartał): ";
                std::cin >> endYear1 >> endMonth1 >> endDay1 >> endQuarter1;
                std::cout << "Podaj datę początkową dla okresu 2 (rok miesiąc dzień kwartał): ";
                std::cin >> startYear2 >> startMonth2 >> startDay2 >> startQuarter2;
                std::cout << "Podaj datę końcową dla okresu 2 (rok miesiąc dzień kwartał): ";
                std::cin >> endYear2 >> endMonth2 >> endDay2 >> endQuarter2;
